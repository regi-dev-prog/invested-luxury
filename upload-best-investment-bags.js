/**
 * InvestedLuxury - Upload "Best Investment Bags 2026" Article
 * ============================================================
 * Run: node upload-best-investment-bags.js
 */
...
// Category ID for "Bags"
const BAGS_CATEGORY_ID = 'ba361de7-98d5-4cda-b94e-93061f5786c2';
...
function richTextBlock(segments) {
  ...
  segments.forEach(segment => {
    const child = { _type: 'span', _key: generateKey(), text: segment.text, marks: [] };
    if (segment.bold) child.marks.push('strong');
    if (segment.italic) child.marks.push('em');
    if (segment.link) {
  ...
  return { _type: 'block', _key: generateKey(), style: 'normal', markDefs, children };
}
...
function generateBody() {
  ...
  // Methodology
  blocks.push(textBlock("How I Chose These Bags (My Methodology)", "h2"));
  ...
  blocks.push(richTextBlock([{ text: "Historical Price Trajectory", bold: true }, { text: " — Has the retail price consistently increased over time without crazy jumps that suggest a bubble?" }]));
  blocks.push(richTextBlock([{ text: "Practical Usability", bold: true }, { text: " — Can you actually use this bag regularly, or is it a shelf piece? Investment bags that you never carry aren't really investments — they're liabilities." }]));
  ...
  // Bag 1: Hermès Birkin
  blocks.push(textBlock("1. Hermès Birkin 25/30 (The Gold Standard, Obviously)", "h2"));
  blocks.push(richTextBlock([
  ...
  // Bag 2: Hermès Kelly
  blocks.push(textBlock("2. Hermès Kelly 25/28 (The Birkin's More Elegant Sister)", "h2"));
  blocks.push(richTextBlock([
    { text: "Brand: ", bold: true },
    { text: "Hermès | " },
    { text: "Price: ", bold: true },
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "If I had to choose between a Birkin 30 and a Kelly 25 at the same price, I'd probably take the Kelly right now. The smaller bag trend is real and doesn't seem to be reversing." }]));
  
  // Bag 3: Chanel Classic Flap
  blocks.push(textBlock("3. Chanel Classic Flap Medium (The Controversial Pick)", "h2"));
  blocks.push(richTextBlock([
    { text: "Brand: ", bold: true },
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "Buy it to USE it. If it also holds value, great. But I wouldn't buy a Classic Flap purely as an investment anymore — the risk profile has changed. Get the medium size in black or beige caviar leather. Avoid seasonal colors unless you genuinely love them." }]));
  blocks.push(richTextBlock([{ text: "Where to buy: ", bold: true }, { text: "Net-a-Porter", link: "https://www.net-a-porter.com" }, { text: " occasionally has inventory, or visit a Chanel boutique directly." }]));
  
  // Bag 4: Lady Dior
  blocks.push(textBlock("4. Dior Lady Dior Medium (The Sleeper Hit)", "h2"));
  blocks.push(richTextBlock([
    { text: "Brand: ", bold: true },
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "This is my pick for \"most undervalued\" on the list. The Lady Dior in black lambskin with gold hardware is a classic that photographs beautifully, carries a royal connection, and costs $4,000 less than a Chanel Classic Flap. The math makes sense." }]));
  blocks.push(richTextBlock([{ text: "Where to buy: ", bold: true }, { text: "Bergdorf Goodman", link: "https://www.bergdorfgoodman.com" }, { text: " has excellent Dior selection." }]));
  
  // Bag 5: Louis Vuitton Neverfull
  blocks.push(textBlock("5. Louis Vuitton Neverfull MM (The Workhorse)", "h2"));
  blocks.push(richTextBlock([
    { text: "Brand: ", bold: true },
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "Not exciting, but smart. Buy it for work, use it for years, sell it when you're done. You'll get most of your money back. The Damier Ebene print ages better than Monogram (which can crack)." }]));
  
  // Bag 6: Bottega Veneta Cassette
  blocks.push(textBlock("6. Bottega Veneta Cassette (The Modern Classic)", "h2"));
  blocks.push(richTextBlock([{ text: "Brand: ", bold: true }, { text: "Bottega Veneta | " }, { text: "Price: ", bold: true }, { text: "$3,800 - $4,200 | " }, { text: "Resale Value: ", bold: true }, { text: "65-80% of retail" }]));
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "Higher risk than the Hermès/Chanel options, but also much more accessible. No waitlists, no games. Walk in and buy one. In 5 years, we'll know if this was a smart call or not — but I'm optimistic. Stick with black, brown, or parakeet green (which has become a modern neutral for the brand)." }]));
  blocks.push(richTextBlock([{ text: "Where to buy: ", bold: true }, { text: "Mytheresa", link: "https://www.mytheresa.com" }, { text: " usually has good color selection." }]));
  
  // Bag 7: The Row Margaux
  blocks.push(textBlock("7. The Row Margaux 15 (The IYKYK Pick)", "h2"));
  blocks.push(richTextBlock([{ text: "Brand: ", bold: true }, { text: "The Row | " }, { text: "Price: ", bold: true }, { text: "$4,800 - $5,200 | " }, { text: "Resale Value: ", bold: true }, { text: "70-85% of retail" }]));
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "This is a play on the quiet luxury trend continuing — which I believe it will. The Row has positioned itself as THE brand for understated wealth. As long as that aesthetic stays relevant, the Margaux holds value. Check out my detailed " }, { text: "Row Margaux review", link: "/bags/row-margaux-review" }, { text: " for more." }]));
  
  // Bag 8: Loewe Puzzle
  blocks.push(textBlock("8. Loewe Puzzle Medium (The Art-World Favorite)", "h2"));
  blocks.push(richTextBlock([{ text: "Brand: ", bold: true }, { text: "Loewe | " }, { text: "Price: ", bold: true }, { text: "$3,650 - $4,100 | " }, { text: "Resale Value: ", bold: true }, { text: "60-75% of retail" }]));
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "Buy if you genuinely love the design. The investment math works, but it's not the primary reason to purchase. The tan colorway has proven most enduring. " }, { text: "SSENSE", link: "https://www.ssense.com" }, { text: " often has interesting color options." }]));
  
  // Bag 9: Goyard Saint Louis
  blocks.push(textBlock("9. Goyard Saint Louis PM/GM (The Ultra-Exclusive Tote)", "h2"));
  blocks.push(richTextBlock([{ text: "Brand: ", bold: true }, { text: "Goyard", link: "https://www.goyard.com" }, { text: " | " }, { text: "Price: ", bold: true }, { text: "$1,700 - $2,100 | " }, { text: "Resale Value: ", bold: true }, { text: "80-100% of retail" }]));
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "If you have access to a Goyard boutique, the Saint Louis is almost a guaranteed value-hold. Get it personalized with initials for resale appeal (yes, personalization actually HELPS here — it proves authenticity). The classic black or navy are safest." }]));
  
  // Bag 10: Celine Triomphe
  blocks.push(textBlock("10. Celine Triomphe (The Balanced Choice)", "h2"));
  blocks.push(richTextBlock([{ text: "Brand: ", bold: true }, { text: "Celine | " }, { text: "Price: ", bold: true }, { text: "$4,000 - $4,600 | " }, { text: "Resale Value: ", bold: true }, { text: "60-75% of retail" }]));
  ...
  blocks.push(richTextBlock([{ text: "My honest take: ", bold: true }, { text: "Good entry point into investment bags if Hermès and Chanel are out of reach. The teen size has good resale, the medium is most practical. I'd stick with smooth calfskin over canvas. " }, { text: "Neiman Marcus", link: "https://www.neimanmarcus.com" }, { text: " is a reliable source." }]));
  
  // Honorable Mentions
  blocks.push(textBlock("Bags That Almost Made the List", "h2"));
  blocks.push(richTextBlock([{ text: "YSL Sac de Jour", bold: true }, { text: " — solid resale (65-70%) and very wearable, but YSL's brand perception has shifted more \"trendy\" than \"investment.\"" }]));
  blocks.push(richTextBlock([{ text: "Hermès Constance", bold: true }, { text: " — excellent investment, but nearly impossible to get at retail. The secondary markup is so high that the \"investment\" aspect becomes questionable." }]));
  blocks.push(richTextBlock([{ text: "Prada Galleria", bold: true }, { text: " — underrated! Resale around 50-60%. Not spectacular but the bag is SO well-made and versatile. Maybe for a future list." }]));
  blocks.push(richTextBlock([{ text: "Fendi Baguette", bold: true }, { text: " — too cyclical. It was huge, then forgotten, then huge again. That volatility makes me nervous for \"investment\" purposes." }]));
  
  // The Honest Truth
  blocks.push(textBlock("The Honest Truth About \"Investment\" Bags", "h2"));
  ...
  // Quick Reference
  blocks.push(textBlock("Quick Reference: Investment Bags Comparison", "h2"));
  blocks.push(textBlock("For quick comparison, here's how each bag stacks up:"));
  blocks.push(richTextBlock([{ text: "Hermès Birkin: ", bold: true }, { text: "$10,400-$12,500, resale 95-140%, risk: low" }]));
  blocks.push(richTextBlock([{ text: "Hermès Kelly: ", bold: true }, { text: "$9,850-$11,900, resale 90-130%, risk: low" }]));
  blocks.push(richTextBlock([{ text: "Chanel Classic Flap: ", bold: true }, { text: "$10,800, resale 75-90%, risk: medium" }]));
  blocks.push(richTextBlock([{ text: "Dior Lady Dior: ", bold: true }, { text: "$6,500-$7,200, resale 70-85%, risk: low" }]));
  blocks.push(richTextBlock([{ text: "LV Neverfull: ", bold: true }, { text: "$2,030-$2,350, resale 70-80%, risk: low" }]));
  blocks.push(richTextBlock([{ text: "Bottega Cassette: ", bold: true }, { text: "$3,800-$4,200, resale 65-80%, risk: medium" }]));
  blocks.push(richTextBlock([{ text: "The Row Margaux: ", bold: true }, { text: "$4,800-$5,200, resale 70-85%, risk: medium" }]));
  blocks.push(richTextBlock([{ text: "Loewe Puzzle: ", bold: true }, { text: "$3,650-$4,100, resale 60-75%, risk: medium" }]));
  blocks.push(richTextBlock([{ text: "Goyard Saint Louis: ", bold: true }, { text: "$1,700-$2,100, resale 80-100%, risk: low" }]));
  blocks.push(richTextBlock([{ text: "Celine Triomphe: ", bold: true }, { text: "$4,000-$4,600, resale 60-75%, risk: medium" }]));
  
  // FAQ
  blocks.push(textBlock("FAQ: Investment Bags", "h2"));
  blocks.push(richTextBlock([{ text: "What's the best first investment bag?", bold: true }]));
  ...
  blocks.push(richTextBlock([{ text: "Do bags really appreciate in value?", bold: true }]));
  ...
  blocks.push(richTextBlock([{ text: "Should I keep the box and dust bag?", bold: true }]));
  blocks.push(textBlock("Yes, absolutely. Complete packaging can add 10-15% to resale value. Keep the receipt too."));
  blocks.push(richTextBlock([{ text: "Where's the best place to resell?", bold: true }]));
  ...
  blocks.push(richTextBlock([{ text: "Are vintage bags a good investment?", bold: true }]));
  ...
  // Related Reading
  blocks.push(textBlock("Related Reading", "h2"));
  blocks.push(richTextBlock([
  ...
  // Disclosure
  blocks.push(textBlock("Disclosure", "h2"));
...
async function upload() {
  console.log('\n' + '═'.repeat(60));
  console.log('   InvestedLuxury - Upload Article');
  console.log('═'.repeat(60));
  
  const body = generateBody();
  console.log(`\n📝 Generated ${body.length} content blocks`);
  
  // Count links
  let linkCount = 0;
  body.forEach(block => {
    if (block.markDefs) linkCount += block.markDefs.length;
  });
  ...
  const document = {
    ...
    slug: { _type: 'slug', current: 'best-investment-bags-2026' },
    excerpt: "Discover the best investment bags for 2026 based on real resale data. From Hermès Birkin to Bottega Cassette - honest analysis of which designer bags actually hold their value.",
    body: body,
    articleType: 'roundup',
    status: 'published',
    featured: false,
  ...
  console.log(`   Category: Bags (${BAGS_CATEGORY_ID})`);
  console.log(`   Status: ${document.status}`);
  
  console.log('\n⏳ Uploading in 3 seconds... (Ctrl+C to cancel)');
  ...
  try {
    ...
    console.log(`   https://investedluxury.sanity.studio/structure/article;${result._id}`);
    console.log(`\n🌐 View on site (after deploy):`);
    console.log(`   https://investedluxury.com/best-investment-bags-2026`);
