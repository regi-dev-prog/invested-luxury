...
export const PARENT_CATEGORIES: Record<string, ParentCategory> = {
  ...
  wellness: {
    ...
    metaDescription: 'Premium wellness guides covering longevity treatments, luxury wellness retreats, and biohacking tools for optimizing your health and living well for longer.',
    path: '/wellness',
...
export const SUB_CATEGORIES: Record<string, SubCategory> = {
  ...
  'gift-guides': {
    ...
    metaDescription: 'Curated luxury gift guides for every occasion. Find thoughtful presents that make a lasting impression — from designer accessories to wellness splurges.',
    parentSlug: 'guides',
  ...
  'seasonal-guides': {
    ...
    metaDescription: 'Expert seasonal luxury guides. Discover what to buy each season, when to shop the best sales, and which timely investment pieces are worth adding to your wardrobe.',
    parentSlug: 'guides',
  ...
  'investment-guides': {
    ...
    metaDescription: 'Strategic guides to luxury investments. In-depth ROI analysis, resale value data, and expert buying advice to help you invest in pieces that hold their value.',
    parentSlug: 'guides',
